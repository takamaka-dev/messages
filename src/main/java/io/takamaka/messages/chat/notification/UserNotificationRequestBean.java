...
public class UserNotificationRequestBean extends SignedMessageBean {

    public UserNotificationRequestBean(SignedNotificationRequestContentBean signedNotificationRequestContent, String from, String signature, String messageType, String signatureType) {
    ...
    private SignedNotificationRequestContentBean signedNotificationRequestContent;
