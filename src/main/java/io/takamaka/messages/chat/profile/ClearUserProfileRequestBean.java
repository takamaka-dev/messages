...
/**
 * Signed envelope for a {@code clearuserprofile} write — the D6 tombstone. Extends {@link SignedMessageBean}; the
...
public class ClearUserProfileRequestBean extends SignedMessageBean {
     ...
     * @param messageType message type identifier ({@code CLEAR_USER_PROFILE})
     * @param signatureType signature type (e.g., "Ed25519BC")
     */
    public ClearUserProfileRequestBean(
            ClearUserProfileSignedContentBean pl,
            String from,
            String signature,
            String messageType,
     ...
     */
    @JsonProperty("pl")
    private ClearUserProfileSignedContentBean pl;
}
