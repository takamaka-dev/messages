...
/**
 * Signed envelope for a {@code setuserprofile} write. Extends
...
public class SetUserProfileRequestBean extends SignedMessageBean {
     ...
     * @param messageType message type identifier ({@code SET_USER_PROFILE})
     * @param signatureType signature type (e.g., "Ed25519BC")
     */
    public SetUserProfileRequestBean(
            SetUserProfileSignedContentBean pl,
            String from,
            String signature,
            String messageType,
     ...
     */
    @JsonProperty("pl")
    private SetUserProfileSignedContentBean pl;
}
