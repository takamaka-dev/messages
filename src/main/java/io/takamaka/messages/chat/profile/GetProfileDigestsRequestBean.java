...
/**
 * Signed envelope for a {@code getprofiledigests} batch read (nonce-free, D11). Extends {@link SignedMessageBean}; the
...
public class GetProfileDigestsRequestBean extends SignedMessageBean {
     ...
     * @param messageType message type identifier ({@code GET_PROFILE_DIGESTS})
     * @param signatureType signature type (e.g., "Ed25519BC")
     */
    public GetProfileDigestsRequestBean(
            GetProfileDigestsSignedContentBean pl,
            String from,
            String signature,
            String messageType,
     ...
     */
    @JsonProperty("pl")
    private GetProfileDigestsSignedContentBean pl;
}
