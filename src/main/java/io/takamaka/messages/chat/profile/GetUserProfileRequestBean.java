...
/**
 * Signed envelope for a {@code getuserprofile} self-read (nonce-free: idempotent and replay-harmless, design D4). Extends {@link SignedMessageBean}; the
...
public class GetUserProfileRequestBean extends SignedMessageBean {
     ...
     * @param messageType message type identifier ({@code GET_USER_PROFILE})
     * @param signatureType signature type (e.g., "Ed25519BC")
     */
    public GetUserProfileRequestBean(
            GetUserProfileSignedContentBean pl,
            String from,
            String signature,
            String messageType,
     ...
     */
    @JsonProperty("pl")
    private GetUserProfileSignedContentBean pl;
}
