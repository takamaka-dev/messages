...
/**
 * Signed envelope for a {@code getuserprofilepeer} peer read (nonce-free, D4/D9). Extends {@link SignedMessageBean}; the
...
public class GetUserProfilePeerRequestBean extends SignedMessageBean {
     ...
     * @param messageType message type identifier ({@code GET_USER_PROFILE_PEER})
     * @param signatureType signature type (e.g., "Ed25519BC")
     */
    public GetUserProfilePeerRequestBean(
            GetUserProfilePeerSignedContentBean pl,
            String from,
            String signature,
            String messageType,
     ...
     */
    @JsonProperty("pl")
    private GetUserProfilePeerSignedContentBean pl;
}
